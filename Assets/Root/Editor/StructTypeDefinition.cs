...
namespace FlatBuffers
{
    ...
    public class StructTypeDefinition : TypeDefinition
    {
        ...
        /// </summary>
        public IEnumerable<FieldTypeDefinition> Fields => _fields;
        ...
        {
            get => _originalOrdering;
            internal set
            {
                _originalOrdering = value;
                if (value)
                    Metadata.Add(StructTypeMetadata.ORIGINAL_ORDER, false);
                else
                    Metadata.Remove(StructTypeMetadata.ORIGINAL_ORDER);
            }
        }
        ...
        public int ForceAlignSize
        {
            ...
            internal set
            {
                ...
                Metadata.Add(StructTypeMetadata.FORCE_ALIGN, value, false);
            }
        }
