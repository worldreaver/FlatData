    ...
    public sealed class FieldTypeDefinition : TypeDefinition
    {
        ...
        public TypeModel NestedFlatBufferType
        {
            ...
            internal set
            {
                ...
                {
                    Metadata.Add(FieldTypeMetadata.NESTED_FLAT_BUFFER, _nestedFlatBufferType.Name, false);
                }
                else
                {
                    Metadata.Remove(FieldTypeMetadata.NESTED_FLAT_BUFFER);
                }
            }
        }
