...
namespace FlatBuffers.Utilities
{
    ...
    {
        private static readonly int[] BaseTypeSizes;
        private static readonly Type[] ClrTypes;
        private static readonly string[] FlatBufferTypeNames;

        private const int OFFSET_SIZE = sizeof(UInt32);
        ...
        static BaseTypeExtensions()
        {
            BaseTypeSizes = new[]
            {
                ...
                sizeof(float), sizeof(double), 0, 0, OFFSET_SIZE, 0
            };
        ...
        {
            return FlatBufferTypeNames[(int) t];
        }
    }
}
#endif