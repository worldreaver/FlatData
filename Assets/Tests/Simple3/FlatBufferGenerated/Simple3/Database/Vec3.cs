...
public struct Vec3 : IFlatbufferObject
{
  ...
  public static Offset<FlatBufferGenerated.Simple3.Database.Vec3> CreateVec3(FlatBufferBuilder builder, float X, float Y, float Z) {
    builder.Prep(4, 12);
    builder.PutFloat(Z);
    builder.PutFloat(Y);
    builder.PutFloat(X);
    return new Offset<FlatBufferGenerated.Simple3.Database.Vec3>(builder.Offset);
  }
};
